...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = JobApplicationPortalConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(JobApplicationPortalDbContext context)
    {
        _context = context;
    }
