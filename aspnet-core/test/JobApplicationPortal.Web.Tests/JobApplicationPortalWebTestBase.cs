...
public abstract class JobApplicationPortalWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static JobApplicationPortalWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(JobApplicationPortalWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<JobApplicationPortalDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<JobApplicationPortalDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<JobApplicationPortalDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<JobApplicationPortalDbContext, Task<T>> func)
    {
        T result;
